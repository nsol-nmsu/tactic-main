...
class Consumer : public ns3::ObjectBase {
    public:
        ...
        typedef Closure< void( UPtr< Response >& ) > OnResponseCb;
        void
        DoOnResponse( OnResponseCb const& cb );
        
        typedef Closure< void( UPtr< Request >& ) > OnRequestCb;
        void
    ...
    private:
        ...
        void
        RetransmitNext( PendingRequest& req );
        ...
        void
        OnResponse( SPtr< PendingRequest >& p, Response& r );
    ...
    private:
        ...
        ns3::TracedValue< Time > m_sumResponseDelay;
};
